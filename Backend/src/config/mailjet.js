            ...
            Messages: [
                {
                    ...
                    HTMLPart: `
                        <div style="background-color: #272727; padding: 20px; color: white; font-family: Arial, sans-serif;">
                            ...
                            <p>Gracias por unirte a nuestra comunidad de gamers. En Gamers Needs encontrarás:</p>
                            ...
                            <p style="margin-top: 20px;">¡Esperamos que disfrutes de tu experiencia con nosotros!</p>
                            <div style="margin-top: 30px; text-align: center;">
                                <a href="${process.env.FRONTEND_URL}" 
                                   style="background-color: #FF4C1A; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">
                                    Visitar Gamers Needs
                                </a>
                            </div>
                        </div>
                    `
