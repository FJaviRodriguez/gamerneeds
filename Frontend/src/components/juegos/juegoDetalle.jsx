          ...
          <div className="bg-zinc-800/50 rounded-lg overflow-hidden">
            <div className="flex gap-8 p-8">
              ...
              <div className="flex-1">
                ...
                <div className="bg-zinc-900/80 p-6 rounded-lg max-w-sm">
                  <p className="text-3xl text-white font-bold mb-4">{juego.precio}€</p>
                  <button 
                    onClick={handleAddToCart} 
                    disabled={isAdding} 
                    className="w-full text-white py-3 rounded-md hover:bg-[#FF6B3D] transition-colors font-medium bg-[#FF4C1A] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
