      ...
      <div className="w-full flex items-center">
        ...
        <div className="flex items-center space-x-24 ml-26">
          ...
          <Link to="/perfil" className="text-white relative group" onClick={handleProfileClick}>
            <img src={getAvatarUrl()} alt="Perfil" className="w-16 h-16 rounded-full opacity-70 group-hover:opacity-100 transition-opacity object-cover border border-gray-600"
              onError={(e) => {
